              ...
              {msg.source_context && (
                <div className="flex flex-col gap-2 mt-2 pt-2 border-t border-white/10">
                  <details className="text-xs group">
                      <summary className="cursor-pointer text-zinc-400 font-semibold hover:text-white transition-colors select-none">Show Retrieved Context</summary>
                      <div className="mt-2 p-3 bg-black/40 rounded-lg text-zinc-300 font-mono text-[10px] whitespace-pre-wrap border border-white/5 max-h-60 overflow-y-auto">
                        {msg.source_context}
                      </div>
                  </details>
                </div>
